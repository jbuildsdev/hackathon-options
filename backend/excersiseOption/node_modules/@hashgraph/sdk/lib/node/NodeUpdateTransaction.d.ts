...
export default class NodeUpdateTransaction extends Transaction {
    ...
    constructor(props?: {
        ...
        gossipCaCertificate?: Uint8Array | null | undefined;
        grpcCertificateHash?: Uint8Array | null | undefined;
     ...
     */
    get gossipEndpoints(): ServiceEndpoint[] | null;
    /**
     ...
     * @returns {?Array<ServiceEndpoint>}
     */
    get serviceEndpoints(): ServiceEndpoint[] | null;
    /**
     * @param {ServiceEndpoint} endpoint
